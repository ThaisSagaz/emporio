...
if (!isset($_SESSION['UsuarioID'])) {
	...
	if ( !empty($_POST)) {
		...
		$sql = "DELETE FROM unidademedida  WHERE cod_unidademedida= ?";
		$q = $pdo->prepare($sql);
		$q->execute(array($id));
		Database::disconnect();
        ...
        <div class="box" id="form">
              ...
              <div class="box box-info" id="form">
                <div class="box-header with-border">
                  <h3 class="box-title">Excluir Unidade de medida</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
               <form class="form-horizontal" id="form" action="Excluir_unidademedida_DAO.php" method="post">

                  <div class="box-body">

                  <input type="hidden" name="id" value="<?php echo $id;?>"/>
              <p class="alert alert-error">Tem certeza que quer excluir esta unidade de medida?</p>
                  ...
                  <div class="box-footer">
                    ...
                    <a class="btn btn-default" href="../unidadedemedida.php">Não</a>
                  </div><!-- /.box-footer -->
                </form>
                </div>
          </div><!-- /.box -->
