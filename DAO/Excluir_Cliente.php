        ...
        <div class="box" id="form">
              ...
              <div class="box box-info" id="form">
                <div class="box-header with-border">
                  <h3 class="box-title">Excluir cliente</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
               <form class="form-horizontal" id="form" action="Excluir_Cliente.php" method="post">

                  <div class="box-body">

                  <input type="hidden" name="id" value="<?php echo $id;?>"/>
              <p class="alert alert-error">Tem certeza que quer excluir este cliente?</p>
                  ...
                  <div class="box-footer">
                    ...
                    <a class="btn btn-default" href="../cliente.php">Não</a>
                  </div><!-- /.box-footer -->
                </form>
                </div>
          </div><!-- /.box -->
