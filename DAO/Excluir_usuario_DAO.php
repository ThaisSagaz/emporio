      ...
      <div class="content-wrapper">
        ...
        <div class="box" id="form">
              ...
              <div class="box box-info" id="form">
                ...
                <!-- form start -->
               <form class="form-horizontal" id="form" action="Excluir_usuario_DAO.php" method="post">

                  <div class="box-body">

                  <input type="hidden" name="id" value="<?php echo $id;?>"/>
              <p class="alert alert-error">Tem certeza que quer excluir esse usuário?</p>
                  ...
                  <div class="box-footer">
                    ...
                    <a class="btn btn-default" href="../usuario.php">Não</a>
                  </div><!-- /.box-footer -->
                </form>
                </div>
          </div><!-- /.box -->
