...
if (!isset($_SESSION['UsuarioID'])) {
	...
	if ( !empty($_POST)) {
		...
		$sql = "DELETE FROM categoriafichatecnica  WHERE codigo = ?";
		$q = $pdo->prepare($sql);
		$q->execute(array($id));
		Database::disconnect();
          ...
          <div class="col-md-12">
              ...
              <div class="box box-info" id="form">
                <div class="box-header with-border">
                  <h3 class="box-title">Excluir Categoria da Ficha Tecnica</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
               <form class="form-horizontal" action="Excluir_categoria_ficha_tecnica_DAO.php" method="post">

                  <div class="box-body">

                  <input type="hidden" name="id" value="<?php echo $id;?>"/>
              <p class="alert alert-error">Tem certeza que quer excluir esta categoria?</p>
                  ...
                  <div class="box-footer">
                    ...
                    <a class="btn btn-default" href="../categoria_ficha_tecnica.php">Não</a>
                  </div><!-- /.box-footer -->
                </form>
                </div>
          </div><!-- /.box -->
