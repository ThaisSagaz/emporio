...
if (!isset($_SESSION['UsuarioID'])) {
	...
	if ( !empty($_POST)) {
		...
		$sql = "DELETE FROM estoque WHERE cod_novacompra = ?";
		$q = $pdo->prepare($sql);
		$q->execute(array($id));
		Database::disconnect();
          ...
          <div class="col-md-12">
              ...
              <div class="box box-info" id="form">
                <div class="box-header with-border">
                  <h3 class="box-title">Excluir esta compra?</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
               <form class="form-horizontal" action="Excluir_novacompra.php" method="post">

                  <div class="box-body">

                  <input type="hidden" name="id" value="<?php echo $id;?>"/>
              <p class="alert alert-error">Tem certeza que quer excluir esta compra?</p>


                  </div><!-- /.box-body -->
                  <div class="box-footer">
                    <button type="submit" class="btn btn-default">Sim</button>
                    <a class="btn btn-default" href="../cadastrar_nova_compra.php">Não</a>
                  </div><!-- /.box-footer -->
                </form>
                </div>
          </div><!-- /.box -->
