    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="row">
            <div class="col-xs-12">
            <a class="btn btn-danger" href="forms/cadastrar_unidademedida.php">Novo</a>
         ...
         <?php
             ...
             ;
              foreach ($pdo->query($sql) as $row) {
                  ...
                  echo '<td width=180>';
                  echo '<a class="btn btn-default" href="forms/atualizar_unidademedida.php?id='.$row['cod_unidademedida'].'">Alterar</a>';
                  echo '&nbsp;';
                  echo '<a class="btn btn-danger" href="DAO/Excluir_unidademedida_DAO.php?id='.$row['cod_unidademedida'].'">Apagar</a>';
                  echo '</td>';
                  echo '</tr>';
             }
             Database::disconnect();
