    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <a class="btn btn-primary" href="forms/cadastrar_ficha_tecnica.php">Novo</a>
          <section class="content-header">
          </section>
        <div class="row">
            <div class="col-xs-12">
         ...
         <?php
             ...
             ;
              foreach ($pdo->query($sql) as $row) {
                  ...
                  echo '<td width=180>';
                  echo '<a class="btn btn-default" href="DAO/Visualizar_fichatecnica_DAO.php?id='.$row['cod_fichaTecnica'].'">Visualizar</a>';
                  echo '&nbsp;';
