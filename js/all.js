...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Título","<Acessar Sistema>","Menu"],
    DREX_NODE_LINKS: ["index.htm","_acessar_sistema_.htm","menu.htm"],
...
DR_EXPLAIN.data_search = {
    ...
    DREXPLAIN_ERROR_LOCAL_SEARCH : "O Google Chrome e Opera 12.02 e superiores n&#x00E3;o suportam a pesquisa em ficheiros HTML locais. Carregue os seus ficheiros para o servidor web ou use outro navegador."
