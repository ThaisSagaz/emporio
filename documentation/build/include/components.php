<section id="components" data-spy="scroll" data-target="#scrollspy-components">
  ...
  <div class="box box-solid">
    <div class="box-body" style="position: relative;">
      ...
      <header class="main-header" style="position: relative;">
        <!-- Logo -->
        <a href="index2.php" class="logo" style="position: relative;"><b>Admin</b>LTE</a>
  ...
  &LT;a href="../../index2.php" class="logo">
    &LT;!-- LOGO -->
    AdminLTE
  &LT;/a>
...
&LT;header class="main-header">
  &LT;nav class="navbar navbar-static-top">
    ...
    &LT;div class="navbar-header">
      &LT;a href="../../index2.php" class="navbar-brand">&LT;b>Admin&LT;/b>LTE&LT;/a>
...
<pre class="prettyprint"><code class="lang-php">&LT;!-- The Right Sidebar -->
...
&LT;div class="control-sidebar-bg">&LT;/div></code></pre>
  ...
  <pre class="prettyprint"><code class="lang-php">&LT;button class="btn btn-default" data-toggle="control-sidebar">Toggle Right Sidebar&LT;/button></code></pre>
  <!-- ===================================================================== -->
  ...
  <pre class="prettyprint"><code class="lang-php">&LT;div class="info-box">
...
&LT;/div>&LT;!-- /.info-box --></code></pre>
  ...
  <p class="lead">Markup</p>
  <pre class="prettyprint"><code class="lang-php">&LT;!-- Apply any bg-* class to to the info-box to color it -->
...
&LT;/div>&LT;!-- /.box --></pre>
  ...
  <pre class="prettyprint"><code class="php">&LT;script>
...
&LT;/script></code></pre>
  ...
  <pre class="prettyprint"><code class="php">&LT;div class="overlay">
...
&LT;/div>
  ...
  <pre class="prettyprint"><code class="php">
