...
<html>
  <head>
    ...
    <title>Relatorio de perdas</title>
          ...
          <div class="span10 offset1">
            <div class="row">
               ...
               <div class="box-header with-border">
                ...
                <h3 class="box-title">Exibir Relatório de Perdas</h3>
             
            </div>
            
            <form class="form-group" action="relatorios/relatorio_perdas.php" method="post">
