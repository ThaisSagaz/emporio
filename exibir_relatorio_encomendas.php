          ...
          <div class="span10 offset1">
            <div class="row">
               ...
               <div class="box-header with-border">
                ...
                <h3 class="box-title">Exibir Relatório de Encomendas</h3>
             
            </div>
        
            <form class="form-group" action="relatorios/relatorio_encomendas.php" method="post">
            <div class="form-group">
              ...
              <label class="control-label" for="situacao">Situação</label>
                    <select name = "situacao" class = "form-control" id="situacao" style="width: 252px; height: 42px">
