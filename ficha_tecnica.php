          ...
          <section class="content-header">
              ...
              <div class="box">
                <div class="box-header">
                      <h3 class="box-title">Fichas Tecnicas</h3>
                  <div class="box-tools">
         ...
         <?php
             ...
             ;
              foreach ($pdo->query($sql) as $row) {
                  ...
                  echo '<td width=180>';
                  //echo '<a class="btn btn-danger" href="forms/atualizar_fichatecnica.php?id='.$row['cod_fichaTecnica'].'">Atualizar</a>';
                  echo '&nbsp;';
                  echo '<a class="btn btn-default" href="DAO/visualizar_fichatecnica.php?id='.$row['cod_fichaTecnica'].'">Visualizar</a>';
                    echo '&nbsp;';
                  echo '<a class="btn btn-danger" href="DAO/Excluir_fichatecnica.php?id='.$row['cod_fichaTecnica'].'">Apagar</a>';
                  echo '</td>';
                  echo '</tr>';
             }
             Database::disconnect();
