      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-database"></i> <span>Início</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-database"></i> <span> Vendas </span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="../../index.php"><i class="fa fa-circle-o"></i> Entrada de Produtos</a></li>
                <li><a href="../../index2.php"><i class="fa fa-circle-o"></i> Realizar Vendas </a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
                <i class="fa fa-database"></i> <span>Encomendas</span> <i class="fa fa-angle-left pull-right"></i>
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-database"></i> <span>Ficha Tecnica</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="../../index.php"><i class="fa fa-circle-o"></i> Categoria Ficha tecnica </a></li>
                <li><a href="../../index2.php"><i class="fa fa-circle-o"></i> Ficha Tecnica </a></li>
                <li><a href="../../index2.php"><i class="fa fa-circle-o"></i> Produto Final</a></li>
                <li><a href="../../index2.php"><i class="fa fa-circle-o"></i> Registro de saida</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="../../index.php"><i class="fa fa-circle-o"></i> Cadastrar Ingrediente</a></li>
                <li><a href="../../index2.php"><i class="fa fa-circle-o"></i> Realizar Compra</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
                <i class="fa fa-dashboard"></i> <span>Relatório</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="../layout/top-nav.php"><i class="fa fa-circle-o"></i> Encomendas</a></li>
                <li><a href="../layout/boxed.php"><i class="fa fa-circle-o"></i> Vendas</a></li>
                <li><a href="../layout/fixed.php"><i class="fa fa-circle-o"></i> Perdas</a></li>
                <li><a href="../layout/collapsed-sidebar.php"><i class="fa fa-circle-o"></i> Estoque</a></li>
                <li><a href="../layout/collapsed-sidebar.php"><i class="fa fa-circle-o"></i> Fichas Técnicas</a></li>
              </ul>
            </li>
              <li class="treeview">
              <a href="#">
                <i class="fa fa-dashboard"></i> <span>Adiministração</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="../layout/top-nav.php"><i class="fa fa-circle-o"></i> Usuário </a></li>
                <li><a href="../layout/boxed.php"><i class="fa fa-circle-o"></i> Produto </a></li>
                <li><a href="../layout/fixed.php"><i class="fa fa-circle-o"></i> Cliente</a></li>
              ...
              <li class="treeview">
              <a href="#">
                <i class="fa fa-dashboard"></i> <span> Alterar Senha </span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              ...
              <li class="treeview">
              <a href="#">
                <i class="fa fa-dashboard"></i> <span> Sair </span> <i class="fa fa-angle-left pull-right"></i>
              </a>
