...
--
-- Host: 127.0.0.1
-- Generation Time: 23-Jun-2016 às 21:10
...
INSERT INTO `estoque` (`cod_novacompra`, `identificacao`, `preco`, `cod_ingrediente`, `quantidade_total`, `quantidade`) VALUES
(14, 'Un', '2.00', 2, '5.000', '0.500'),
(22, 'Kg', '30.00', 25, '1.000', '1.000');
...
--
ALTER TABLE `estoque`
  ADD CONSTRAINT `estoque_ibfk_1` FOREIGN KEY (`cod_ingrediente`) REFERENCES `ingrediente` (`cod_ingrediente`);
...
--
ALTER TABLE `receita`
  ADD CONSTRAINT `receita_ibfk_1` FOREIGN KEY (`cod_novacompra`) REFERENCES `estoque` (`cod_novacompra`);
