...
--
-- Host: 127.0.0.1
-- Tempo de geração: 21/06/2016 às 19:49
...
(1, 'Jéssica Rocha Cardoso', '861.584.455-09', 'Jessica.cardosor@gmail.com', '', 'Rua São João n15e', '', '071 8309-8938', 'f', 'prox a bar de valdomiro', 'vip'),
(5, 'Fulano de Tal', '711.002.644-26', 'fulano@gmail.com', '71 00000-0000', 'Rua Um', '', '71  9999-9999', 'f', 'proximo a rua dois', 'Selecione a Categoria'),
...
(21, 'Rafael Joaquim Lucca Pereira', '868.102.339-03', 'rafael.joaquim.pereira@lumavale.com.br', '71 32131-2543', 'Travessa Hermínio Andrade', '', '71 99183-6524', 'f', 'proximo a rua dois', 'normal'),
(22, 'Benício Enrico Luiz Rocha', '000.171.997-19', 'benicio_e_rocha@osite.com.br', '11 11111-1111', '1ª Travessa Engenheiro Durval', '', '22 22222-2222', 'f', 'Periperi', 'normal');
...
INSERT INTO `encomendas` (`cod_Encomenda`, `dtpedido`, `dtentrega`, `cod_cliente`, `Valor`, `totalPago`, `situacao`) VALUES
(1, '2016-03-10', '2016-03-20', 19, 111, '111.00', 'Entregue'),
(2, '2016-06-21', '2016-06-30', 21, 20, '15.00', 'A fazer'),
(3, '2016-06-21', '2016-06-22', 5, 20, '20.00', 'A fazer'),
(5, '2016-06-21', '2016-06-30', 22, 100, '0.00', 'A fazer');
...
(1, 1, 10, 'Disponivel', '2016-06-30', 'Interno', NULL, NULL),
(2, 3, 2, 'Disponivel', '2016-06-30', 'Interno', NULL, NULL);
...
(9, 15, '1.000', '10.16', '10.16'),
(9, 16, '1.000', '4.70', '4.70'),
(9, 17, '1.000', '4.33', '4.33'),
(9, 21, '1.000', '1.41', '1.41');
...
(14, 'L', '2.00', 2, '7.400', '0.500'),
(15, 'L', '3.50', 13, '11.000', '1.000'),
(22, 'Kg', '20.00', 25, '5.000', '1.000');
...
(9, 'Torta de Côco com Goiaba e Calabresa', 'P', '25.30', '100.00', 0);
...
(1, 'Torta Doce de leite', 'P', '222.22', 1, NULL),
(2, 'Bolo de trigo', 'P', '20.00', 1, NULL),
(3, 'torta de goiabada com queijo', 'P', '100.00', 7, NULL);
...
CREATE TABLE IF NOT EXISTS `registro_saida` (
  `cod_registrosaida` int(11) NOT NULL AUTO_INCREMENT,
  `cod_produtofinal` int(11) NOT NULL,
  `quantidade_torta` int(11) NOT NULL,
  `data_saida` date DEFAULT NULL,
  `hora_saida` time DEFAULT NULL,
  PRIMARY KEY (`cod_registrosaida`),
  KEY `cod_produtofinal` (`cod_produtofinal`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
(11, 'Rodrigo Conceição dos Santos', '2147483647', 'rodrigoFN.CDV@gmail.com', '7133976874', 'rodrigo', 'e10adc3949ba59abbe56e057f20f883e', 'Administração'),
(20, 'Gabriel Lima', '504.887.939-20', 'Gabriel@emporio.com', '71 99999-9990', 'gabriel', '81dc9bdb52d04dc20036dbd8313ed055', 'Administracao'),
(22, 'Caroline Pimentel', '928922', 'caroline_pimentel@yahoo.com.br', '71 99165-0169', 'cpimentel', '827ccb0eea8a706c4c34a16891f84e7b', 'Administração'),
(23, 'Jessica Rocha Cardoso', '861.584.455-09', 'jessica.cardosor@gmail.com', '71-8309-8938', 'jessica', '827ccb0eea8a706c4c34a16891f84e7b', 'Vendas');
