              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      Empório das Tortas - Web Developer
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="index1.php"><i class="fa fa-circle-o"></i> Entrada de Produtos</a></li>
                <li><a href="index1.php"><i class="fa fa-circle-o"></i> Realizar Vendas </a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
