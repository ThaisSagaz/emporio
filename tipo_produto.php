    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="row">
            <div class="col-xs-12">
             <a class="btn btn-danger" href="forms/cadastrar_tipoproduto.php">Novo</a>
             <section class="content-header">
          </section>
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Tipo de Produtos</h3>
                  <div class="box-tools">
                  ...
                  <table id="example" class="views-table cols-6 table table-striped table-bordered">
                    ...
                    <tbody>
                      <?php
    					   ...
    					   $sql = "SELECT cod_tipoproduto, nome from tipoproduto;";
    	 				   foreach ($pdo->query($sql) as $row) {
    						   		echo '<tr>';
    							   	echo '<td>'. $row['nome'] . '</td>';
    							   	echo '<td width=180>';
    							   	echo '<a class="btn btn-danger" href="forms/atualizar_tipoproduto.php?id='.$row['cod_tipoproduto'].'">Atualizar</a>';
    							   	echo '&nbsp;';
    							   	echo '<a class="btn btn-default" href="DAO/excluir_tipoprod.php?id='.$row['cod_tipoproduto'].'">Apagar</a>';
    							   	echo '</td>';
    							   	echo '</tr>';
    					   }
    					   Database::disconnect();
