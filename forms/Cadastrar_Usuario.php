          ...
          <div class="row">
            <div class="col-md-12">
              <div class="box box-warning">
                ...
                <div class="box-body">
                  <form action="../DAO/Cadastrar_usuario_DAO.php" method="post">
                    <div class="form-group">
                      <label>Nome</label>
                      <input type="text" class="form-control" name="name" required="required" placeholder="Nome" value="">
                    </div>
                    <div class="form-group">
                      <label>CPF</label>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      <label>Login</label>
                      <input type="text" class="form-control" name="login" required="required" placeholder="Login" value="">
                    </div>
                    <div class="form-group">
                      <label>Senha</label>
                      <input type="password" class="form-control" name="senha" required="required" placeholder="Senha" value="">
                    </div>
