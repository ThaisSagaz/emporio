  ...
  <meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1"/>
    ...
    <script type="text/javascript">
        ...
        function changePermissaoMenuVendas() {
            ...
            var escEstoque = document.getElementById('EscEstoque');
            escEstoque.style.display = "none";
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <!-- Optionally, you can add icons to the links -->
              ...
              <li "ficha" class="active treeview">
                ...
                <ul  class="treeview-menu">
                  <li class=""><a href="../categoria_ficha_tecnica.php"><i class="fa fa-circle-o"></i> Categorias da Ficha Técnica </a></li>
                  <li class=""><a href="../ficha_tecnica.php"><i class="fa fa-circle-o"></i> Ficha Técnica </a></li>
                  <li class=""><a href="../produto_final.php"><i class="fa fa-circle-o"></i> Produto Final </a></li>
                  <li class=""><a href="../registro_saida.php"><i class="fa fa-circle-o"></i> Registro de Saída </a></li>
                </ul>
              </li>
              <li "MenuEstoque" class="active treeview">
                ...
                <ul id="EscEstoque" class="treeview-menu">
                  ...
                  <li id="estoque" class=""><a href="../estoque.php"><i class="fa fa-circle-o"></i> Cadastrar Ingrediente </a></li>
                  <li id="estoque" class=""><a href="../cadastrar_nova_compra.php"><i class="fa fa-circle-o"></i> Realizar Nova Compra </a></li>
                </ul>
              </li>
              <li class="active treeview">
