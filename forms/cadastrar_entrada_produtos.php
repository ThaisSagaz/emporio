...
require '../conexao/database.php';
    ...
    if ($valid) {
      ...
      $sql = "INSERT INTO estoquevenda(cod_Produto,quantidade,status,validade,origem) values(?, ?, ?,?,?)";
      $q = $pdo->prepare($sql);
      $q->execute(array($cod_Produto,$quantidade,$status,$validade,$origem));
      ...
      <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="box box-warning">
                ...
                <div class="box-body">
                  <form action="../forms/cadastrar_entrada_produtos.php" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="quantidade" required="required" value="">
                    </div>
        ...
        <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="date" class="form-control" name="validade" id="preco" required="required" placeholder="Valor Unitário" value="">
            </div>

            <div class="form-group">
                    <label>Origem:</label>
                    <select class="form-control" name="origem"  required="required" id="opcao">
                        <option value="" disabled selected style='display:none;'>Origem do produto</option>
