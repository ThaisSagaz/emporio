          ...
          <div class="span10 offset1">
            <div class="row">
               ...
               <div class="box-header with-border">
                 <h3 class="box-title">Exibir Relatório de Vendas</h3>
               </div>
          
            <form class="form-group" action="relatorios/relatorio_vendas.php" method="post">
            <div class="form-group">
              <div class="box-body" >
                <label for="data_1">Data Inicial:</label>
                 <input type="date" class="form-control" name="data_1" id="data_1" value="<?php echo $data_saida; ?>"/>
             </div>
           <div class="box-body" >
