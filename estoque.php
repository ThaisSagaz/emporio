    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="row">
            <div class="col-xs-12">
             <a class="btn btn-danger" href="forms/cadastrar_ingrediente.php">Novo</a>
                  ...
                  <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        ...
                        <th class="views-field views-field-id">Unidade de Medida</th>
                        <th class="views-field views-field-id">Valor Unitário</th>
                    ...
                    <tbody>
                       <?php
                           ...
                           $sql = "SELECT ingrediente.*,unidademedida.nome as unidade, ingrediente.nome as ingrediente FROM ingrediente
                           ...
                           ;
                            foreach ($pdo->query($sql) as $row) {
                                ...
                                echo '<td>'. $row['unidade'] . '</td>';
                                 echo '<td>' . 'R$ ' . number_format($row['valorunitario'], 2, ',', '.') .   '</td>';
                                echo '<td width=180>';
